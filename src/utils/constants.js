...
export const theatres = [
  ...
  },
  {
    ...
    img: pvr,
    timings: [
      { time: "1:15 PM", label: "PVR PXL" },
      { time: "4:30 PM", label: "PVR PXL" },
      { time: "8:00 PM", label: "PVR PXL", highlight: true },
      { time: "10:30 PM", label: "PVR PXL" },
    ],
  },
  {
    ...
    img: cinepolis,
    timings: [
      { time: "10:30 AM", label: "DOLBY 7.1" },
      { time: "1:45 PM", label: "DOLBY 7.1" },
      { time: "5:15 PM", label: "DOLBY 7.1" },
      { time: "11:25 PM", label: "DOLBY 7.1", highlight: true },
    ],
  },
  {
  ...
  },
  {
    ...
    img: pvr,
    timings: [
      { time: "08:10 PM", label: "PVR PXL" },
      { time: "11:30 PM", label: "PVR PXL" },
      { time: "2:00 PM", label: "PVR PXL", highlight: true },
      { time: "5:45 PM", label: "PVR PXL" },
    ],
  },
  {
    ...
    img: cinepolis,
    timings: [
      { time: "9:00 AM", label: "DOLBY 7.1" },
      { time: "12:15 PM", label: "DOLBY 7.1", highlight: true },
      { time: "3:45 PM", label: "DOLBY 7.1" },
      { time: "9:30 PM", label: "DOLBY 7.1" },
    ],
  },
];
...
export const colors = ["Red", "Blue", "Green", "Black", "White", "Yellow", "Purple", "Pink"];
